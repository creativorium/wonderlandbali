			...
			foreach ( $items as $item ) :
				...
				<article class="wl-services__card">
					...
					<div class="wl-services__body">
						<?php if ( $title ) : ?>
							<h3 class="wl-services__name"><?php echo wp_kses_post( $title ); ?></h3>
						<?php endif; ?>
						<?php if ( $text ) : ?>
							<p class="wl-services__text"><?php echo wp_kses_post( $text ); ?></p>
						<?php endif; ?>
						<?php if ( $btn && $url ) : ?>
							<a class="wl-services__cta" href="<?php echo esc_url( $url ); ?>"><?php echo esc_html( $btn ); ?></a>
						<?php endif; ?>
					</div>
				</article>
			<?php endforeach; ?>
